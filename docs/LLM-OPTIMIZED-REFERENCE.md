...
Task DAG MCP tools (35): task_create, task_update, task_edit, task_delete, task_get, task_list, task_move, task_search, task_archive, task_add_edge, task_remove_edge, task_get_dag, task_topological_sort, task_link_code, task_unlink_code, task_get_code_refs, task_find_by_code_node, task_suggest_code_links, task_find_conflicts, task_contradiction_report, task_check_isolation, task_blast_radius, task_execution_order, task_validate, task_build_context, task_export, note_add, note_update, note_list, note_delete, contract_add, contract_update, contract_list, task_roadmap, task_roadmap_diff
...
Contradictions (3 Ps): task_find_conflicts(depth=1) → task_contradiction_report → LLM semantic analysis
